...
class MyMacro(Runnable):
    ...
    def run(self, progress_callback):
        ...
        args = ['ec2', 'terminate-instances', '--instance-ids', '$(aws ec2 describe-instances --query "Reservations[].Instances[].InstanceId" --filters "Name=eks:cluster-name,Values={}'.format(self.config['clusterId'])" --output text)'']
